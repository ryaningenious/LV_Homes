export default function Placeholder({ width = 1200, height = 1200 }: { width?: number; height?: number }) {
  return (
    <>
      <svg className="object-cover" xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none">
