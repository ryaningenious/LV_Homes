...
function App() {
  ...
  return (
    <div className="relative">
      <GrainyBackground>
        <div className="fixed top-0 left-0 z-999 right-0 px-4 md:px-6 py-4 md:py-8">
        ...
        <nav
          id="navbar"
          className="sticky top-0 left-0 right-0 z-999 px-4 md:px-6 py-4 md:py-8"
        >
        ...
        <div
          id="hero-tagline"
          className="px-4 md:px-6 py-4 md:py-8 mt-32 md:mt-16 md:space-y-3"
        >
        ...
        <section id="about-section" className="h-[200vh] hidden md:block">
          <div className="h-screen relative">
            ...
            <div className=" sticky bottom-0 right-0 left-0 flex justify-center">
              <div
                id="about-background"
                className="w-32 h-32 rounded-t-full bg-black  "
              ></div>
              <div
                id="about-content"
                className="font-nyght absolute top-0 text-5xl px-16 w-screen h-screen  flex items-center justify-center"
              >
        ...
        <section id="about-section-mbl" className="md:hidden">
          <div className="flex justify-center items-center h-screen bg-black">
            <div className="font-nyght text-3xl px-16">
              " At Lux Veritas Homes, we believe in crafting homes that blend
              elegance with integrity. Our mission is to bring light and truth
        ...
        <section id="featured-section">
          <div className="min-h-screen bg-white text-gray-900 space-y-16 pb-16">
            <p className="text-center md:text-right md:px-32 text-5xl md:text-7xl">
              Featured Project
            </p>
            <div className="flex flex-wrap max-w-7xl mx-auto gap-x-8 justify-center items-center p-4 gap-y-8">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((_el, i) => (
                <div
                  key={i}
                  className="min-w-[100%] md:min-w-[30%] h-96 flex flex-col flex-nowrap"
                >
                  <img
                    src="null"
                    alt=""
                    className="w-full grow bg-gray-300 rounded-xl hover:-skew-3"
                  />
                  <div className="p-4 text-xl">Lorem, ipsum dolor sit amet</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section
          id="partner-section"
          className="w-screen min-h-[60vh] bg-white py-8 text-gray-900"
        >
          ...
          <div className="min-h-screen bg-white text-gray-900 space-y-16 py-16">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 max-w-7xl mx-auto p-4">
              {[1, 2, 3].map((_el, i) => (
                <div
                  key={i}
                  className="min-w-[100%] md:min-w-[30%] min-h-96 flex flex-col flex-nowrap"
                >
                  <img
                    src="null"
                    alt=""
